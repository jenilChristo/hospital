...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i>Forms</a>
  <ul>
    <li  <?php if(basename($_SERVER['PHP_SELF'])=='home.php'){ echo 'active'; } ?>><a href="home.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>
    ...
    <li class="submenu "> <a href="#"><i class="icon icon-list"></i> <span>Manage Secondary user</span> <span class="label label-important">3</span></a>
      <ul>
